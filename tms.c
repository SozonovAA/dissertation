 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Mar 12 16:20:40 2021
 */
...
/* Output Port  0 */
#define OUT_PORT_0_NAME       betta_o
...
#define SOURCEFILES           "__SFB__svpwm.c"
#define PANELINDEX            8
...
extern void tms_Outputs_wrapper(const real_T *wt_i,
			const real_T *ud_i,
			const real_T *us_a_i,
			real_T *betta_o,
			real_T *Ta_o,
...
{
    const real_T *wt_i = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *ud_i = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *us_a_i = (real_T *) ssGetInputPortRealSignal(S, 2);
    real_T *betta_o = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *Ta_o = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *Tb_o = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *Tc_o = (real_T *) ssGetOutputPortRealSignal(S, 3);
    real_T *Us_o = (real_T *) ssGetOutputPortRealSignal(S, 4);

    tms_Outputs_wrapper(wt_i, ud_i, us_a_i, betta_o, Ta_o, Tb_o, Tc_o, Us_o);
