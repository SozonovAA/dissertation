 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Fri Mar 12 14:20:55 2021
 */
...
#define SOURCEFILES           "__SFB__Магистратура диплом/svpwm.c"
#define PANELINDEX            8
...
extern void tms_Outputs_wrapper(const real_T *wt,
			const real_T *f_pwm,
			const real_T *ud,
			const real_T *us_a,
			real_T *betta,
...
{
    const real_T *wt = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *f_pwm = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *ud = (real_T *) ssGetInputPortRealSignal(S, 2);
    const real_T *us_a = (real_T *) ssGetInputPortRealSignal(S, 3);
    real_T *betta = (real_T *) ssGetOutputPortRealSignal(S, 0);
    real_T *Ta = (real_T *) ssGetOutputPortRealSignal(S, 1);
    real_T *Tb = (real_T *) ssGetOutputPortRealSignal(S, 2);
    real_T *Tc = (real_T *) ssGetOutputPortRealSignal(S, 3);
    real_T *Us = (real_T *) ssGetOutputPortRealSignal(S, 4);

    tms_Outputs_wrapper(wt, f_pwm, ud, us_a, betta, Ta, Tb, Tc, Us);
